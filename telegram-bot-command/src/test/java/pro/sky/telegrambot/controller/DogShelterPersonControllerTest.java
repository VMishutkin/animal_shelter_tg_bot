...
public class DogShelterPersonControllerTest {

    static DogShelterPerson person = new DogShelterPerson();
    ...
    @InjectMocks
    DogShelterPersonController personController;

    @Mock
    private DogShelterPersonService personService;
