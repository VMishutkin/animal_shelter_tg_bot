...
public class Strings {
    ...
    public static final String DELETE_CONTACT = "Для удаления контакта из списка, введите его ID, его вы можете посмотреть в Списке контактов";
    public static final String APPOINT_GUARDIAN = "Чтобы назначит контакт усыновителем введите ID контакта";
    public static final String EXTEND_PROBATION = "Чтобы продлить испытательный срок введите через пробел ID нарушителя и число штрафных дней + \n" +
            "Например: 12 7";
