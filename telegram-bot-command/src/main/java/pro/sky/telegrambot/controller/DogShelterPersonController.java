...
import pro.sky.telegrambot.service.DogShelterPersonService;

import java.util.List;

@RestController
@RequestMapping("person/dog-shelter")
public class DogShelterPersonController {

    private final DogShelterPersonService personService;


    public DogShelterPersonController(DogShelterPersonService dogShelterPersonService) {
        this.personService = dogShelterPersonService;
    ...
    @PutMapping
    public Person editPerson(@RequestBody DogShelterPerson person) {
